...
function filtrarDatos(){
    ...
    if(arrayBusqueda.length>0){
        busqueda.innerHTML= '<input class="filtrar__busqueda" id="busqueda" type="text" placeholder="Escribe para filtra" onkeyup="filtrar()">';
        resultado.innerHTML = pintarUsuarios(arrayBusqueda);;
    }else{
        texto+= "<h3>No ahi coincidencias</h3>";
